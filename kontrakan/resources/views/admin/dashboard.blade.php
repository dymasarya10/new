        ...
        <div class="col-lg-12 mb-4">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <p style="text-align: justify; text-indent: 10px">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Eligendi itaque alias cum veritatis, quas
                        ex
                        expedita placeat ad laborum voluptate at earum cupiditate officiis facere obcaecati, debitis magni
                        optio
                        iure.
                    </p>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 mb-4">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Keterangan Warna Tagihan</h6>
                        </div>
                        <div class="card-body">
                            <div class="text-center">
                                <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;"
                                    src="{{ asset('assets/admin/img/undraw_analysis_dq08.svg') }}" alt="...">
                            </div>
                            <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quibusdam error id, dolores
                                cupiditate dolore blanditiis numquam porro earum aliquam. Voluptatibus, eaque? Itaque quos
                                deleniti cupiditate similique, error tenetur ut libero!</p>
                        </div>
                    </div>
