    ...
    <div class="modal fade" id="createtestimon" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form method="post" action="/createvacancies" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Nama Lowongan</label>
            ...
            @foreach ($collection as $item)
                <tr>
                    ...
                    <td>
                        ...
                        <button type="button" class="btn btn-danger"><a href="/deletevacancies/{{ $item->id }}"
                ...
                <div class="modal fade" id="exampleModal{{ $item->id }}" tabindex="-1"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <p><strong>Nama Lowongan : </strong></p>
                                <p>{{$item->title}}</p>
                ...
                <div class="modal fade" id="exampleModal{{ $item->id }}edit" tabindex="-1"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="/updatevacancies/{{ $item->id }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('put')
                                    <div class="mb-3">
                                        <label for="exampleInputEmail1" class="form-label">Nama Lowongan</label>
