    ...
    <div class="modal fade" id="createhomephotos" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form method="post" action="/storevid" enctype="multipart/form-data">
                    @csrf
        ...
        <tbody>
            @foreach ($collection as $item)
                <tr>
                    ...
                    <td>
                        <img src="{{asset('storage/'.$item->pict)}}" alt="" class="img-thumbnail" width="300">
                    </td>
                    <td>
                        ...
                        <button type="button" class="btn btn-danger"><a href="/deletevid/{{$item->id}}" onclick="return confirmDelete()"><i class="fas fa-trash"
                ...
                <div class="modal fade" id="exampleModal{{ $item->id }}edit" tabindex="-1"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="/editvid/{{$item->id}}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('put')
                                    <div class="mb-3">
